      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              message,
              // ✏️ แก้ข้อความให้กำลังใจได้ที่ motivationMessage
              style: const TextStyle(
                fontSize: 14,
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      trailing: Row(
        ...
        children: [
          Text(
            '${positive ? '+' : ''}${transaction.xpChange} XP',
            // ✏️ transaction.xpChange
            style: TextStyle(
              fontSize: 14,
              fontWeight: FontWeight.bold,
